...
| :--- | :--- | :--- | :--- |
| **ETHGlobal New York 2026** | 🥇 **1st (Arc)**, 🥇 **1st (Hedera)**, 🥈 **2nd (World ID)** | **MARS**: Marketplace for Audited, Reputable AI-agent skills where World-ID-verified auditors compete to vet MCP tools and agent capabilities, Chainlink attests verdicts, Hedera records trust scores and verification, and agents pay-per-version via Arc x402 to safely use only audited skills. | [Repo](https://github.com/Cedctf/ethnyc) |
